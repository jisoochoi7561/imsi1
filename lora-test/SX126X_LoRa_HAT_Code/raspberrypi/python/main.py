...
node = sx126x.sx126x(serial_num = "/dev/ttyS0",freq=915,addr=100,power=22,rssi=False,air_speed=2400,relay=False)

def send_deal():
    get_rec = ""
    print("")
    print("input a string such as \033[1;32m100,915,Hello World\033[0m,it will send `Hello World` to lora node device of address 100 with 915M ")
